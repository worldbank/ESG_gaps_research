...
if one stipulates that country/indicator series with a volatility coefficient no higher than 0.588
(the median) can be extrapolated or estimated one year forward, coverage in 2018 would improve from 31% to 39%
