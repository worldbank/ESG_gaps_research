...
```{r setupcoverage, cache=TRUE,echo=FALSE, message=FALSE, warning=FALSE}
...
if (knitr::is_latex_output()) {
  # g1
  knitr::include_graphics("figs/ciavailability.png")
}
```
...
if(knitr::is_html_output()) {
  ...
  knitr::kable(dd3, 
               format = "html",
               col.names=c('Indicator', 'Code', 'Max. Countries'),
...
if(knitr::is_html_output()) {
  knitr::kable(data.frame(columns, values), 
               format = "html",
               col.names=c('Year of MRV', '# Indicators'), 
               table.attr='class="striped"',
