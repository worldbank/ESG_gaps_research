...
```{r c_i_availability, echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "Number of countries per indicator over time", fig.margin = TRUE, fig.width = 10, fig.height = 12}
pg1
```

# Variability of ESG indicators

```{r esg_var, echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "Density o fcoefficient of variation of ESG indicators", fig.margin = TRUE, fig.width = 4.5, fig.asp = .75}
...
```{r c_i_var, echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "Number of countries per indicator over time", fig.margin = TRUE, fig.width = 10, fig.height = 12}
pg2
```
...
```{r p_decade, echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "Number of surveys produce in each decade", fig.fullwidth = TRUE, fig.width = 10, fig.height = 2}
h
```
