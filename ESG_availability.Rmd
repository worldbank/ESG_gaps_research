...
Most of the indicators of interest to ESG work are handled by Wendy - 33, followed by Florina - 24, Hiroko 23, Haruna 17 and Bhaskar 14. **Andrei: We have to complete this paragraph**
...
# esg %>% count(source2, topic) %>% 
#   ggplot(aes(x = n, y = topic)) +
#   geom_segment(aes(yend = topic), xend = 0, colour = "grey50") +
#   geom_point(size = 3, aes(colour = source2)) +
#   scale_colour_brewer(palette = "Set1", limits = c("NL", "AL"), guide = FALSE) +
#   theme_bw() +
#   theme(panel.grid.major.y = element_blank()) +
#   facet_grid(source2 ~ ., scales = "free_y", space = "free_y")
