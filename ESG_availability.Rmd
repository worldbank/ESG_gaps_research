...
```{r subject2, echo = FALSE, fig.width = 4.5, fig.asp = .75, fig.cap = "Class of indicators", fig.margin = TRUE}
esg %>% count(subject) %>% 
  ggplot(aes(area = n, fill = subject, 
             label = paste(subject, "\n", n))) +
  geom_treemap(
