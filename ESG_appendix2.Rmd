# Appendix: Extended Coverage Analysis
...
defined and identified in the body of this analysis, and may be useful for future research purposes.

**TODO:** revise text to make it suitable as an appendix.

The availability of ESG indicators by country is dynamic over time. As shown in Figure \@ref(fig:app-ciavailability), not all indicators are available in all countries neither they are available in all years. The availability of indicators goes from darker to lighter. The lighter the color the more the greater the number of countries per indicator in each year.  

```{r app-ciavailability, fig.width = 12, fig.height = 10, fig.cap = "Number of countries per indicator over time"}
pg1
```
