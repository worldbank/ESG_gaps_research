...
*TGH: let's discuss this methodology. CV is s standard formula, stdev/mean so I don't think we need to describe it in depth. I don't think
it requires normalization, and I'm concerned that the need for interpolation isn't correct and might be smoothing the calculation.*

*TGH: 4.2 seems to be at cross purposes to conclusions of 4.1*
