...
**ANDRES: NOT SURE WHAT NEEDS TO HAPPEN HERE IN LIGHT OF WHAT WE DISCUSSED TODAY. DO YOU WANT TO DISCUSS MORE
OR JUST PROCEED AND TAKE A FIRST CRACK?**
...
reasons exaplain in section [Explanation Framework Analysis](#explanations). Yet, as see in Figure
...
econometrics models. In this section, we show how feasibile it would be to extrapalote some ESG indicators based on their time coverage and volatility in each country. 
