...
*Options for Improving Use of ESG for Soveraign Bond Analysis* (World Bank, 2018).
...
This report uses a different selection of ESG indicators than that used in the 2018 report: 135 indicators
...
Conversely, we decided to some indicators used exclusively by one data provider (Versk-Maplecroft) because strong
